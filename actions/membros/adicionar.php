<?php
// RESPONSABILIDADE: ponto de entrada para a action de adicionar membro (POST)
// Arquivo chamado diretamente pelo formulário: action="actions/membros/adicionar.php"
//
...
//   6. chamar MembroController::adicionar()
